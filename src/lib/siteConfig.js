export const SITE_URL = 'https://eladroz-swyxkit.netlify.app';
export const APPROVED_POSTERS_GH_USERNAME = ['swyxio', 'eladroz'];
export const GH_USER_REPO = 'eladroz/swyxkit'; // used for pulling github issues and offering comments
